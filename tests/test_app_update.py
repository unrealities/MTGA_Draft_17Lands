...
def valid_input_url_zip():
    return 'https://github.com/unrealities/MTGA_Draft_17Lands/releases/download/MTGA_Draft_Tool_V{PREVIOUS_APPLICATION_VERSION}/MTGA_Draft_Tool_V{PREVIOUS_APPLICATION_VERSION}.zip'
