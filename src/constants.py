...
COLOR_NAMES_DICT = {
    CARD_COLOR_LABEL_WHITE: CARD_COLOR_LABEL_WHITE,
    CARD_COLOR_LABEL_BLUE: CARD_COLOR_LABEL_BLUE,
    CARD_COLOR_LABEL_BLACK: CARD_COLOR_LABEL_BLACK,
    CARD_COLOR_LABEL_RED: CARD_COLOR_LABEL_RED,
    CARD_COLOR_LABEL_GREEN: CARD_COLOR_LABEL_GREEN,
    "WU": "Azorius",
    "UB": "Dimir",
    "BR": "Rakdos",
    "RG": "Gruul",
